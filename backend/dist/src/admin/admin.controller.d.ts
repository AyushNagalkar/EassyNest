...
export declare class AdminController {
    ...
    deactivateUser(id: string, adminId: string): Promise<{
        id: string;
        email: string;
        name: string;
        isActive: boolean;
    }>;
    reactivateUser(id: string, adminId: string): Promise<{
        id: string;
        email: string;
        name: string;
        isActive: boolean;
    ...
    forceRemoveProperty(id: string, adminId: string): Promise<{
        message: string;
    }>;
    ...
    reviewFlag(id: string, adminId: string, body: {
