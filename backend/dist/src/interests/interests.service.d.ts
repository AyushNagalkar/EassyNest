...
export declare class InterestsService {
    ...
    constructor(prisma: PrismaService, notificationsService: NotificationsService, emailService: EmailService, scoringService: ScoringService);
    create(fromUserId: string, dto: CreateInterestDto): Promise<{
        targetProperty: ({
            owner: {
                id: string;
                email: string;
    ...
    decline(interestId: string, userId: string): Promise<{
        targetProperty: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    private getInterestForResponse;
}
